...
def load_localization_model():
    ...
    checkpoint_path = os.path.join(project_root, 'weights', 'best_model_proper.pth')
...
def run_localization_test():
    print('SMALLUNET BCE LOCALIZATION TEST')
    print('=' * 60)
    ...
    output_dir = os.path.join(project_root, 'test_results', 'localization_bce2')
    ...
    for i, image_id in enumerate(test_images, 1):
        ...
        output_path = os.path.join(output_dir, f'bce_test_{i}.png')
